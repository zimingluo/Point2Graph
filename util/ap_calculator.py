...
from util.box_util import (extract_pc_in_box3d, flip_axis_to_camera_np,
                            get_3d_box, get_3d_box_batch)
from util.eval_det import eval_det, eval_det_multiprocessing, get_iou_obb
from util.nms import nms_2d_faster, nms_3d_faster, nms_3d_faster_samecls
...
class APCalculator(object):
    ...
    def step(
        ...
        return batch_gt_map_cls, batch_pred_map_cls
