...
class MPCAT40Dataset(data.Dataset):
    def __init__(self, detected_objects):        
        ...
        self.openshape_data = {'xyz': [], 'rgb': [], 'category': []}
        for detected_object in detected_objects:
            self.openshape_data['xyz'].append(detected_object[:, :3])
            self.openshape_data['rgb'].append(detected_object[:, 3:6])
...
class PointCloudDataset(data.Dataset):
    def __init__(self, detected_objects):
        # self.categories = ["bed", "chair", "sofa", "table", "door", "cabinet", "window", "counter", "desk", "curtain", "toilet", "sink", "bathtub",  "bookshelf", "fridge",  "picture", "shower"]
        
        self.category_dict ={"cabinet": 0,
                        "bed": 1,
                        "chair": 2,
                        "sofa": 3,
                        "table": 4,
