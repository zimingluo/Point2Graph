...
import util.pc_util as pc_util
from util.box_util import (flip_axis_to_camera_np, flip_axis_to_camera_tensor,
                            get_3d_box_batch_np, get_3d_box_batch_tensor)

from util.pc_util import scale_points, shift_scale_points
from util.random_cuboid import RandomCuboid
import json
import math
...
class ScannetDetectionDataset(Dataset):
    def __init__(
        ...
        self.data_path = os.path.join(root_dir, 'scannet_train_detection_data')
        all_scan_names = list(
            set(
                [
        ...
        #     set(
        #         [
        #             os.path.basename(x).split('_vert')[0]
        #             for x in os.listdir(self.data_path)
        #             if x.endswith("npy")
        #         ]
        #     )
        # )
        # self.scan_names = sorted(all_scan_names)[95:]
        # args.filt_empty = False
